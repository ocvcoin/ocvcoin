...
// ocvcoin includes.
#include <..\src\script\ocvcoinconsensus.h>
...
int main()
{
    std::cout << "ocvcoinconsensus version: " << ocvcoinconsensus_version() << std::endl;
    ...
    auto op0Result = ocvcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, ocvcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
