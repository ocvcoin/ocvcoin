...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the ocvcoin repository."
  exit 1
fi
...
# See https://github.com/ocvcoin/ocvcoin/issues/16064
...
echo 'When compiling ocvcoind, run `./configure` in the following way:'
echo
