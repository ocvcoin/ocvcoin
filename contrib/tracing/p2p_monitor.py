...
""" Interactive ocvcoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Ocvcoin Core can enable. It uses BCC
...
def main(ocvcoind_path):
    ...
    ocvcoind_with_usdts.enable_probe(
