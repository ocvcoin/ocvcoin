...
"""Example logging Ocvcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/ocvcoind
...
def main(ocvcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[ocvcoind_with_usdts])
