...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef OCVCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define OCVCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the ocvcoin network\n')
    ...
    g.write('#endif // OCVCOIN_CHAINPARAMSSEEDS_H\n')
