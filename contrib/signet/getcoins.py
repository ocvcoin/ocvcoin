...
def ocvcoin_cli(rpc_command_and_params):
    argv = [args.cmd] + args.ocvcoin_cli_args + rpc_command_and_params
    try:
...
if args.faucet.lower() == DEFAULT_GLOBAL_FAUCET:
    ...
    curr_signet_hash = ocvcoin_cli(['getblockhash', '1'])
...
if args.addr == '':
    ...
    args.addr = ocvcoin_cli(['getnewaddress', 'faucet', 'bech32'])
