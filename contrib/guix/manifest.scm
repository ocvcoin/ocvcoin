...
(define* (make-ocvcoin-cross-toolchain target
                                       #:key
...
desirable for building Ocvcoin Core release binaries."
...
(define glibc-2.27/ocvcoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-ocvcoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/ocvcoin-patched
