# Bootstrappable Ocvcoin Core Builds

This directory contains the files necessary to perform bootstrappable Ocvcoin
Core builds.
...
- 24GB of free disk space on the partition that the Ocvcoin Core git repository
  resides in
...
For a Ocvcoin Core depends development environment, simply invoke
...
From the top of a clean Ocvcoin Core repository:
...
To use dongcarl's substitute server for Ocvcoin Core builds after having
