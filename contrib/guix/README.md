...
To build Ocvcoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Ocvcoin Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/ocvcoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/ocvcoin-core/guix.sigs).
