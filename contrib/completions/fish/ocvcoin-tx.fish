...
# Extract options
function __fish_ocvcoin_tx_get_options
...
# Extract commands
function __fish_ocvcoin_tx_get_commands
...
complete \
    --command ocvcoin-tx \
    --condition "not __fish_ocvcoin_seen_cmd (__fish_ocvcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_ocvcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command ocvcoin-tx \
    --arguments "(__fish_ocvcoin_tx_get_commands)" \
    --no-files
