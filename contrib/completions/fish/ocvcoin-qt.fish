...
complete --command ocvcoin-qt --no-files

# Extract options
function __fish_ocvcoinqt_get_options
...
complete \
    --command ocvcoin-qt \
    --arguments "(__fish_ocvcoinqt_get_options --nofiles)"
