...
def main(args):
    ...
    if not success:
        print("ocvcoin.org failed to provide signature file, "
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("ocvcoin.org and bitcoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Ocvcoin Core binary release "
