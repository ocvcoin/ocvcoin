...
* for `src/leveldb`: https://github.com/ocvcoin-core/leveldb.git (branch ocvcoin-fork)
* for `src/univalue`: https://github.com/ocvcoin-core/univalue.git (branch master)
