...
# TestP2PConn: A peer we use to send messages to ocvcoind, and store responses.
...
class CompactBlocksTest(OcvcoinTestFramework):
    ...
    # This test actually causes ocvcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ocvcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for ocvcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # ocvcoind will not send blocktxn responses for blocks whose height is
