...
class ToolWalletTest(OcvcoinTestFramework):
    ...
    def ocvcoin_wallet_process(self, *args):
        ...
        return subprocess.Popen([self.options.ocvcoinwallet] + default_args + list(args), stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
