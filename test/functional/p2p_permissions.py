...
class P2PPermissionsTests(OcvcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].ocvcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].ocvcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
