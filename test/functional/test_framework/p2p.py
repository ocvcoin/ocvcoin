...
# Copyright (c) 2010-2020 The Ocvcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test objects for interacting with a ocvcoind node over the p2p protocol.

The P2PInterface objects interact with the ocvcoind nodes under test using the
...
MAGIC_BYTES = {
    "mainnet": b"\xf9\xbe\xb4\xd7",   # mainnet
    "testnet3": b"\x0b\x11\x09\x05",  # testnet3
    "regtest": b"\xfa\xbf\xb5\xd9",   # regtest
    "signet": b"\xb1\x2c\x49\xc2",    # signet
}
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, *, net, timeout_factor):
        ...
        logger.debug('Connecting to Ocvcoin Node: %s:%d' % (self.dstaddr, self.dstport))
    ...
    def peer_accept_connection(self, connect_id, connect_cb=lambda: None, *, net, timeout_factor):
        ...
        logger.debug('Listening for Ocvcoin Node with id: {}'.format(connect_id))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Ocvcoin node.
