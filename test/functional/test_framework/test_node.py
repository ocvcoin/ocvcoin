...
class TestNode():
    ...
    def __init__(self, i, datadir_path, *, chain, rpchost, timewait, timeout_factor, ocvcoind, ocvcoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False):
        """
        Kwargs:
        ...
        self.ocvcoinconf = self.datadir_path / "ocvcoin.conf"
        ...
        self.cli = TestNodeCLI(ocvcoin_cli, self.datadir_path)
        ...
        for _ in range(poll_per_s * self.rpc_timeout):
            if self.process.poll() is not None:
                ...
                raise FailedToStartError(self._node_msg(
                    f'ocvcoind exited with status {self.process.returncode} during initialization. {str_error}'))
            try:
                rpc = get_rpc_proxy(
    ...
    def wait_until_stopped(self, *, timeout=OCVCOIND_PROC_WAIT_TIMEOUT, expect_error=False, **kwargs):
