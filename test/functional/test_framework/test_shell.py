...
class TestShell:
    """Wrapper Class for OcvcoinTestFramework.

    The TestShell class extends the OcvcoinTestFramework
    ...
    class __TestShell(OcvcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by OcvcoinTestFramework child class.
            self.num_nodes = 1
