...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/ocvcoin/ocvcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(OcvcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our ocvcoind node")
