...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the OcvcoinTestFramework
    pass


class ExampleTest(OcvcoinTestFramework):
    # Each functional test is a subclass of the OcvcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        OcvcoinTestFramework class so other tests can use it."""
