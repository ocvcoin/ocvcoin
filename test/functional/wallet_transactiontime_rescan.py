...
class TransactionTimeRescanTest(OcvcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine OCV and create transactions
        ...
        # generate some ocv to create transactions and check blockcount
        ...
        # send 10 ocv to user's first watch-only address
        self.log.info('Send 10 ocv to user')
        ...
        # send 5 ocv to our second watch-only address
        self.log.info('Send 5 ocv to user')
        ...
        # send 1 ocv to our third watch-only address
        self.log.info('Send 1 ocv to user')
