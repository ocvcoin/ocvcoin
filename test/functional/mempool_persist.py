...
By default, ocvcoind will dump mempool on shutdown and
...
class MempoolPersistTest(OcvcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ocvcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
