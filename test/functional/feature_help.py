...
"""Verify that starting ocvcoin with -h works as expected."""

from test_framework.test_framework import OcvcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(OcvcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ocvcoin with -h for help text")
        ...
        self.log.info("Start ocvcoin with -version for version information")
        ...
        self.log.info("Start ocvcoind with -fakearg to make sure it does not start")
