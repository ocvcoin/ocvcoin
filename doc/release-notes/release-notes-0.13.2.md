Ocvcoin Core version 0.13.2 is now available from:

  <https://ocvcoin.org/bin/ocvcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update ocvcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ocvcoin-tx to create v2 transactions (ocvdrak)
