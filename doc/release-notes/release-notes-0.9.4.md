Ocvcoin Core version 0.9.4 is now available from:

  https://ocvcoin.org/bin/0.9.4/
...
this update is incompatible with the Ocvcoin system and could lead to consensus
forks.

Ocvcoin Core released binaries from https://ocvcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ocvcoin/+archive/ubuntu/ocvcoin
- A third-party or self-compiled Ocvcoin Core

upgrade to Ocvcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
