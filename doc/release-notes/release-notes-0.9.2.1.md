Ocvcoin Core version 0.9.2.1 is now available from:

  https://ocvcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OCV to 0.01 OCV
...
- Fix "Start ocvcoin on system login"
