Ocvcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ocvcoin/files/Ocvcoin/ocvcoin-0.5.4/
...
http://gitorious.org/ocvcoin/ocvcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Ocvcoin-Qt notifications under Growl 1.3.
Increase required age of Ocvcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOcvcoin properly when installing Ocvcoin-Qt over it. (Windows)
