Ocvcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ocvcoin/files/Ocvcoin/ocvcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ocvcoin
...
New/changed settings (command-line or ocvcoin.conf file)
--------------------------------------------------------
