Ocvcoin Core version 0.14.1 is now available from:

  <https://ocvcoin.org/bin/ocvcoin-core-0.14.1/>
...
here:
[reducing-ocvcoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` ocvcoin-tx input verification (awemany, jnewbery)
