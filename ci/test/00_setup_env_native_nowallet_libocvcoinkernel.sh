...
export CONTAINER_NAME=ci_native_nowallet_libocvcoinkernel
...
export GOAL="install"
export OCVCOIN_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
