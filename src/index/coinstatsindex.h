// Copyright (c) 2020-2021 The Ocvcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef OCVCOIN_INDEX_COINSTATSINDEX_H
#define OCVCOIN_INDEX_COINSTATSINDEX_H
...
#endif // OCVCOIN_INDEX_COINSTATSINDEX_H
