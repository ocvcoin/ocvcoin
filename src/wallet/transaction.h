...
#ifndef OCVCOIN_WALLET_TRANSACTION_H
#define OCVCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this ocvcoin node, and set to 0 for transactions that were created
...
#endif // OCVCOIN_WALLET_TRANSACTION_H
