...
#ifndef OCVCOIN_WALLET_WALLETUTIL_H
#define OCVCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! ocvcoin from opening the wallet, thinking it was newly created, and
...
#endif // OCVCOIN_WALLET_WALLETUTIL_H
