...
#ifndef OCVCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define OCVCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Ocvcoin Core wallet was originally a collection of unrelated private
...
#endif // OCVCOIN_WALLET_SCRIPTPUBKEYMAN_H
