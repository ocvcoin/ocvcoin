...
#ifndef OCVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define OCVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // OCVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
