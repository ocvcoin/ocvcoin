...
#ifndef OCVCOIN_SCRIPT_STANDARD_H
#define OCVCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a ocvcoin address
 */
...
/**
 * Generate a Ocvcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // OCVCOIN_SCRIPT_STANDARD_H
