...
#ifndef OCVCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define OCVCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // OCVCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
