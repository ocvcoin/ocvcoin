...
#ifndef OCVCOIN_KERNEL_CONTEXT_H
#define OCVCOIN_KERNEL_CONTEXT_H
...
//! passed to external libocvcoin_kernel functions which need access to this
...
#endif // OCVCOIN_KERNEL_CONTEXT_H
