...
#ifndef OCVCOIN_TEST_SCRIPTNUM10_H
#define OCVCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ocvcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // OCVCOIN_TEST_SCRIPTNUM10_H
