...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, OcvcoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &OcvcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &OcvcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &OcvcoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &OcvcoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &OcvcoinGUI::updateWalletStatus);
    connect(gui, &OcvcoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
