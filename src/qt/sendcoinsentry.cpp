    ...
    platformStyle(_platformStyle)
{
    ...
    // normal ocvcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying ocvcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &OcvcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
