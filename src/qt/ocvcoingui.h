...
#ifndef OCVCOIN_QT_OCVCOINGUI_H
#define OCVCOIN_QT_OCVCOINGUI_H
...
/**
  Ocvcoin GUI main class. This class represents the main window of the Ocvcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class OcvcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit OcvcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~OcvcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a ocvcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, OcvcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Ocvcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(OcvcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // OCVCOIN_QT_OCVCOINGUI_H
