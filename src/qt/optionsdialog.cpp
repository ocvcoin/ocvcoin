      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->ocvcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ocvcoinAtStartup);
    ...
    ui->ocvcoinAtStartup->setToolTip(ui->ocvcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->ocvcoinAtStartup->setText(ui->ocvcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openOcvcoinConfButton->setToolTip(ui->openOcvcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new OcvcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ocvcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSOCVontrols);
...
void OptionsDialog::on_openOcvcoinConfButton_clicked()
{
