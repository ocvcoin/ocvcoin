...
#ifndef OCVCOIN_QT_GUIUTIL_H
#define OCVCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Ocvcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ocvcoin:" URI into recipient object, return true on successful parsing
