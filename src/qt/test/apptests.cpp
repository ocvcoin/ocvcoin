...
//! Entry point for OcvcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &OcvcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for OcvcoinGUI tests.
void AppTests::guiTests(OcvcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &OcvcoinGUI::consoleShown, this, &AppTests::consoleTests);
