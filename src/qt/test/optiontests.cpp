...
{
    // Test regression https://github.com/ocvcoin/ocvcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/ocvcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/ocvcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Ocvcoin/Ocvcoin-Qt.conf and all else left as default,
    // ocvcoin-qt should set both -listen and -listenonion to false and start successfully.
