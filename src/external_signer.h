// Copyright (c) 2018-2021 The Ocvcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef OCVCOIN_EXTERNAL_SIGNER_H
#define OCVCOIN_EXTERNAL_SIGNER_H
...
#endif // OCVCOIN_EXTERNAL_SIGNER_H
