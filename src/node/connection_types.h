...
#ifndef OCVCOIN_NODE_CONNECTION_TYPES_H
#define OCVCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/ocvcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Ocvcoin’s Peer-to-Peer Network")
...
#endif // OCVCOIN_NODE_CONNECTION_TYPES_H
