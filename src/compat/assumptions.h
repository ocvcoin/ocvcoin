...
#ifndef OCVCOIN_COMPAT_ASSUMPTIONS_H
#define OCVCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Ocvcoin cannot be compiled without assertions."
#endif
...
#endif // OCVCOIN_COMPAT_ASSUMPTIONS_H
