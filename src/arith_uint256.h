...
#ifndef OCVCOIN_ARITH_UINT256_H
#define OCVCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Ocvcoin only uses this "compact" format for encoding difficulty
