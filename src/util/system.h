 ...
 */
#ifndef OCVCOIN_UTIL_SYSTEM_H
#define OCVCOIN_UTIL_SYSTEM_H
...
extern const char * const OCVCOIN_CONF_FILENAME;
extern const char * const OCVCOIN_SETTINGS_FILENAME;
