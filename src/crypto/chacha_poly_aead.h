...
#ifndef OCVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define OCVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@ocvcoin.
 *
 ...
 *
 * The chacha20-poly1305@ocvcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@ocvcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@ocvcoin are relatively fast in
...
#endif // OCVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
