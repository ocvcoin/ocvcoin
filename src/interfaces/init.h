...
#ifndef OCVCOIN_INTERFACES_INIT_H
#define OCVCOIN_INTERFACES_INIT_H
...
//! (ocvcoin-gui, ocvcoin-node, ocvcoin-wallet, ocvcoind, ocvcoin-qt) and each
...
#endif // OCVCOIN_INTERFACES_INIT_H
