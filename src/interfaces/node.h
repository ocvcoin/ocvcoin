...
#ifndef OCVCOIN_INTERFACES_NODE_H
#define OCVCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a ocvcoin node (ocvcoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or ocvcoin.conf.
...
#endif // OCVCOIN_INTERFACES_NODE_H
